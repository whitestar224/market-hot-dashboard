...
powershell.exe -NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -File "%~dp0tools\start_dragon_wave_precompute.ps1" -Version v91
start "" "http://127.0.0.1:8791/dragon-wave.html?v=91"
endlocal
